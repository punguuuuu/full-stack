    ...
    if (this.checkDetails()) {
      ...
      const res = await fetch(
        `logIn?email=${encodeURIComponent(
          document.querySelector(".lineEdit").value
      ...
      if (logInStatus.success) {
        ...
        this.props.close();
      } else if (logInStatus.message === "User not found !") {
        this.setState({ emailError: logInStatus.message });
      } else if (logInStatus.message === "Incorrect password !") {
        this.setState({ passwordError: logInStatus.message });
      } else if (logInStatus.message === "Email not confirmed !") {
        this.setState({ emailError: logInStatus.message });
      }
    }
  };
  ...
  signUp = async () => {
    ...
    if (this.checkDetails()) {
      ...
      const res = await fetch("signUp", {
        ...
        body: JSON.stringify({
          email: document.querySelector(".lineEdit").value,
      ...
      } else if (signUpStatus.message === "User already exist !") {
        this.setState({ emailError: signUpStatus.message });
      } else if (signUpStatus.message === "Password too short !") {
        this.setState({ passwordError: signUpStatus.message });
      }
    }
  };
    ...
    return (
      <>
        ...
        >
          ...
          <li>
            <a href="#index" onClick={() => this.changePage("index.html")}>
              Home
            </a>
          </li>
          <li>
            <a href="#shop" onClick={() => this.changePage("shop.html")}>
              Shop
            </a>
          </li>
          <li>
            <a href="#gallery" onClick={() => this.changePage("gallery.html")}>
              Gallery
            </a>
          </li>
          <li>
            <a href="#game" onClick={() => this.changePage("game.html")}>
              Stacker
            </a>
          </li>
          <li>
            <a href="#art" onClick={() => this.changePage("art.html")}>
              Art?
            </a>
          </li>
          <li>
            <a
              ...
              onClick={() => this.changePage("account.html")}
            >
              Account
            </a>
          </li>
    ...
    return (
      <>
        ...
        <AccountModal
          ...
          close={() => this.showAccountModal(false)}
        />
      </>
    );
  }
